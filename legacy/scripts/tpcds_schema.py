"""TPC-DS table schemas as PyArrow schemas for Iceberg table creation."""
...
CUSTOMER = pa.schema([
    ...
    ("c_last_review_date_sk", pa.int64()),
])
...
# Dimension tables (batch loaded once)
DIMENSION_TABLES = {
    "date_dim": DATE_DIM,
    "time_dim": TIME_DIM,
    "item": ITEM,
...
# Fact tables (streaming micro-batches)
FACT_TABLES = {
